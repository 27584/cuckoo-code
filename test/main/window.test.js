...
test('addWindow 与 getWindowContext 往返', () => {
  ...
  windowState.addWindow(fakeWin, 'p1', fakeStore);
...
test('getContextByWebContents 查找对应上下文', () => {
  ...
  windowState.addWindow(winA, 'p1', { a: 1 });
  windowState.addWindow(winB, 'p2', { b: 2 });
...
test('removeWindow 后 getWindowContext 返回 null', () => {
  ...
  windowState.addWindow(fakeWin, 'p1', {});
...
test('getAllWindows 返回窗口数组', () => {
  ...
  windowState.addWindow(winA, 'p1', {});
  windowState.addWindow(winB, 'p2', {});
