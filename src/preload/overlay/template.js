...
'      <div class="cuckoo-actions">',
'        <button id="cuckoo-mcp-save" class="cuckoo-btn cuckoo-btn-primary">保存配置</button>',
'        <button id="cuckoo-mcp-send" class="cuckoo-btn cuckoo-btn-secondary" title="把当前 MCP 工具信息发送给 AI">发送 MCP 信息给 AI</button>',
'      </div>',
'    </div>',
'  </div>',
'</div>',
