...
'    <div class="cuckoo-section">',
'      <div class="cuckoo-session-header">',
'        <span class="cuckoo-label">已配置的 MCP Server</span>',
'        <button id="cuckoo-mcp-refresh" class="cuckoo-btn-refresh-sessions" title="刷新">🔄 刷新</button>',
'      </div>',
...
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section">',
'      <div class="cuckoo-label">添加 MCP Server（JSON）</div>',
'      <textarea id="cuckoo-mcp-json" class="cuckoo-cmd-preview" rows="6" style="font-size:11px;" placeholder="{\n  \"name\": \"filesystem\",\n  \"type\": \"stdio\",\n  \"command\": \"npx\",\n  \"args\": [\"-y\", \"@modelcontextprotocol/server-filesystem\", \"C:/my-project\"]\n}"></textarea>',
'      <button id="cuckoo-mcp-add" class="cuckoo-btn cuckoo-btn-primary">添加/更新</button>',
'    </div>',
'  </div>',
'</div>',
...
'  z-index: 2147483647; width: 360px; height: 80vh; max-height: 85vh;',
'  background: rgba(17, 19, 34, 0.98);',
...
'.cuckoo-window-item .cuckoo-window-name { color: #c8ccff; font-weight: 600; }',
'.cuckoo-window-item .cuckoo-window-status { color: #5d6280; font-size: 10px; }',
